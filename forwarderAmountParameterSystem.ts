 ...
 * AMO: The number of parts to be sent to the beneficiaries.
 * Hook Parameter to delete accounts and amount values using Invoke transactions: DEL: Number (from 00 to 13)
 */

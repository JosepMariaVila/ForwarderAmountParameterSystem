...
|01|amount01: a number-part from 0 to 10 in hex| 
|||
|02|address02 translated to AccountID|
|03|amount02 a number-part from 0 to 10 in hex|
|||
|04|address03 translated to AccountID|
|05|amount03 a number-part from 0 to 10 in hex|
|||
|06|address04 translated to AccountID|
|07|amount04 a number-part from 0 to 10 in hex|
|||
|08|address05 translated to AccountID|
|09|amount05 a number-part from 0 to 10 in hex|
|||
|0A|address06 translated to AccountID|
|0B|amount06 a number-part from 0 to 10 in hex|
|||
|0C|address07 translated to AccountID|
|0D|amount07 a number-part from 0 to 10 in hex|
|||
|0E|address08 translated to AccountID|
|0F|amount08a number-part from 0 to 10 in hex|
|||
|10|address09 translated to AccountID|
|11|amount09 a number-part from 0 to 10 in hex|
|||
|12|address10 translated to AccountID|
|13|amount10 a number-part from 0 to 10 in hex|
...
Beneficiary 2:
- NU1: 02
- ADD: (the desired beneficiary raddress converted to AccountID)
- NU2: 03
- AMO: 01 (the desired amount of parts to send, in this case 1 part out of 10)
...
To delete a hook state you have to create an Invoke transaction from the hook account and use as parameter DEL and the position between 00 to 13 (00, 01, 02, 03, 04, 05, 06, 07, 08, 09, 0A, 0B, 0C, 0D, 0E, 0F, 10, 11, 12 or 13) as the value to be deleted (1 invoke transaction for each element to delete):
